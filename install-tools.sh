...
then
    ...
    echo "64c43db1f6411df6dbe679d0881ac021b4fc8aec1b565a324cc6207aeada042f  /tmp/fd.tar.gz" | sha256sum -c --quiet
...
then
    ...
    echo "8ee6ff537341681f9e91bae2d5da451b15c575691e33980893732d866d3cefc4 /tmp/hadolint" | sha256sum -c --quiet
...
then
    ...
    echo "ee4e0751ab108b6da4f47c52da187d5177dc371f0f512a7caaec5434e711c091  /tmp/rg.tar.gz" | sha256sum -c --quiet
...
then
    ...
    echo "ab6ee1b178f014d1b86d1e24da20d1139656c8b0ed34d2867fbb834dad02bf0a  /tmp/shellcheck-$SHELLCHECK_VERSION.linux.x86_64.tar.xz" | sha256sum -c --quiet
